...
<main class="bg-blue-50 text-blue-900 p-6">
  <h1 class="text-4xl px-4 mt-10 mb-5">Popheads Chart (Summer 2020 - Summer 2023)</h1>

  <p class="ml-4">
    (takes a while to load the first time, click the link
    <a
      class="text-blue-700 underline hover:text-blue-800"
      href="https://popheads-chart-cs0o.onrender.com/"
      target="_blank"
  ...
  {#if loading}
    <div
      id="new-site-loading"
      class="border-solid border-black border-2 w-5/6 h-96 my-8 mx-auto flex items-center justify-center"
    >
  ...
  {:else}
    <iframe
      id="new-site"
      class="border-solid border-black border-2 w-5/6 h-96 my-8 mx-auto"
      title="Popheads Chart Preview"
      src="https://popheads-chart-cs0o.onrender.com/"
    ></iframe>
  {/if}

  <article class="text-lg font-medium text-gray-700">
    <p class="mb-3">
      In 2020, I was involved in an online pop music community called Popheads. A great feature of Popheads was
    ...
    <p class="mb-6">
      Unlike the smooth progress of the
      <a class="text-blue-600 hover:text-blue-700" href="../quizbowl-website">Quizbowl Website</a>, progress on
      ...
      together in the end, and I feel proud of how it came out.
    </p>

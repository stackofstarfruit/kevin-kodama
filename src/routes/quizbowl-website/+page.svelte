<script lang="ts">
  ...
  import SiteBeginnings from "./components/SiteBeginnings.svelte";
...
<svelte:head>
  <title>Quizbowl Website</title>
</svelte:head>

<main class="bg-blue-50 text-blue-900 p-6">
  <h1 class="text-4xl px-4 mt-10 mb-10" id="quizbowl-header">
    Quizbowl Website (Winter 2020 - Spring 2023)
  </h1>
  ...
  {:else}
    <iframe
      ...
      title="Quizbowl Website Preview"
      src="https://students.washington.edu/quizbowl"
    ></iframe>
  {/if}
  ...
  <article class="text-lg font-medium text-gray-700">
    <p class="mb-6">
      ...
      technical, I hope it will shed some light on my development process.
    </p>

...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<body class="bg-blue-50 text-blue-900 p-6"><h1 class="text-4xl px-4 mt-10 mb-10">Wandering Inn Visualization (Spring 2021 - Summer 2021)</h1> `);
    {
      $$renderer2.push("<!--[-->");

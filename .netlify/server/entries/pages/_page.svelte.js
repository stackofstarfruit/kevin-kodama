...
const Bio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex flex-col justify-center" data-svelte-h="svelte-100y3bz"><p class="text-base md:text-lg font-medium text-gray-700">Hi! I am Kevin Kodama, a software engineer and writer seeking new ways to explain big ideas. My latest project is a sci-fi &amp; fantasy magazine called <a class="text-blue-600" href="linktr.ee/synthesized.sunsets">Synthesized Sunsets</a>, which explores speculative topics through a romantic lens. Feel free to reach out and send me an email at kevin.kodama (at) protonmail.com!</p></div>`;
});
...
const Essays = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2 id="essays" class="text-3xl px-4 mt-10 text-center" data-svelte-h="svelte-1v4hiez">Essays</h2> <section class="px-4 py-8 space-y-4">${validate_component(Essay, "Essay").$$render(
    ...
    $$result,
    {
      ...
      description: "When I first watched the Studio Ghibli film Castle in the Sky, I really didn’t like it. It took me years to find the words for why. Castle in the Sky is an animated film about the ancient floating city of Laputa. Laputa is said to be a utopia with advanced technology and valuable treasure, making it a prize for explorers of all stripes. The film’s protagonists have a jewel that can locate the city, so they are constantly evading ambitious raiders who hope to gain the power of Laputa for themselves. But when the main characters finally arrive at Laputa, it turns out to be an abandoned wreck. Powerful yet dormant technology is the only lasting legacy of their once-mighty civilization. As the raiders vie for control of the city, they end up unleashing powerful forces they don’t understand. The subsequent struggle sends Laputa into a spiral of self-destruction.",
    ...
    $$result,
    {
      ...
      description: "It’s been three years since the release of Future Nostalgia, the album that put Dua Lipa on top of the pop world. Future Nostalgia was the soundtrack of quarantine for many, and it was widely considered one of the best albums of the new decade. Despite Future Nostalgia’s staying power, it didn’t do opening numbers like you might expect. In fact, the album netted zero number ones. And the album itself didn’t do great numbers either — it peaked at #3 in the US and didn’t even debut at #1 in the UK. These numbers didn’t matter in the end, as Future Nostalgia is now the sixth-most streamed album of all time, and Dua Lipa has enough name recognition to headline the soundtrack of the most anticipated movie in the world. But it demonstrates that the success of Future Nostalgia was far from a foregone conclusion.",
